...
public class ComandoDescer90 : IExternalCommand
{
    public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
    {
        ...
        try
        {
            Reference refTubo = uidoc.Selection.PickObject(ObjectType.PointOnElement, new FiltroTuboPipeMaster(), "PipeMaster [M]: Clique na PONTA do tubo onde deseja descer na vertical (90º)...");
            ...
            XYZ vetorDescida90 = new XYZ(0.0, 0.0, -1.0);
            ...
            XYZ pontoFinalNovo = pontoInicialNovo + vetorDescida90 * comprimentoNovoTubo;
            using (Transaction t = new Transaction(doc, "PipeMaster: Descer 90º"))
            {
                t.Start();
