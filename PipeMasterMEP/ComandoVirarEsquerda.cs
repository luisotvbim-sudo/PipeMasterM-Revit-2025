...
public class ComandoVirarEsquerda : IExternalCommand
{
    public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
    {
        ...
        try
        {
            Reference refTubo = uidoc.Selection.PickObject(ObjectType.PointOnElement, new FiltroTuboPipeMaster(), "PipeMaster [M]: Clique na PONTA do tubo de onde deseja virar à ESQUERDA...");
            ...
            XYZ vetorEsquerda = new XYZ(0.0 - direcaoAvanco.Y, direcaoAvanco.X, direcaoAvanco.Z).Normalize();
            ...
            XYZ pontoFinalNovo = pontoInicialNovo + vetorEsquerda * comprimentoNovoTubo;
            using (Transaction t = new Transaction(doc, "PipeMaster: Virar à Esquerda"))
            {
                t.Start();
